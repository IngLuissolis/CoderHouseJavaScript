...
const Francia = new Pais ("Francia", "./img/france.png")
const Australia = new Pais ("Australia", "./img/australia.png")
const Dinamarca = new Pais ("Dinamarca", "./img/denmark.png")
...
const Belgica = new Pais ("Belgica", "./img/belgium.png")
const Canada = new Pais ("Canada", "./img/canada.png")
const Marruecos = new Pais ("Marruecos", "./img/morocco.png")
const Croacia = new Pais ("Croacia", "./img/croatia.png")
/*objetos paises Grupo G*/
const Brazil = new Pais ("Brazil", "./img/brazil-flag.png")
const Serbia = new Pais ("Serbia", "./img/serbia.png")
const Suiza = new Pais ("Suiza", "./img/switzerland.png")
const Camerun = new Pais ("Camerun", "./img/cameroon.png")
